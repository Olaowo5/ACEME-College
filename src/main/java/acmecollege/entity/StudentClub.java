...
@JsonSubTypes({ @JsonSubTypes.Type(value = AcademicStudentClub.class, name = "academicStudentClub"),
	@JsonSubTypes.Type(value = NonAcademicStudentClub.class, name = "nonAcademicStudentClub"), })
