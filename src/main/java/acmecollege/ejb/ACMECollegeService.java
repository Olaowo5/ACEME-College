...
public class ACMECollegeService implements Serializable {
    ...
    public void buildUserForNewStudent(Student newStudent) {
        ...
        SecurityRole userRole = /* TODO ACMECS01 - Use NamedQuery on SecurityRole to find USER_ROLE */ 
        		em.<SecurityRole>createNamedQuery(SecurityRole.FIND_USER_ROLE, SecurityRole.class)
        ...
        if (student != null) {
            ...
            TypedQuery<SecurityUser> findUser = 
                /* TODO ACMECS02 - Use NamedQuery on SecurityRole to find this related Student
                   ...
                   is not dangling
                */ 
            		em.<SecurityUser>createNamedQuery(SecurityUser.SECURITY_USER_BY_STUDENT_ID_QUERY, SecurityUser.class)
  ...
  // new methods for Club Membership Resource
    public List<ClubMembership> getAllClubMembership() {
        TypedQuery<ClubMembership> allCardsQuery = em.createNamedQuery(ClubMembership.FIND_ALL, ClubMembership.class);
    ...
    public void deleteCardById(int cardId) {
        ...
        public Professor getProfessorById(int id) {
            TypedQuery<Professor> specificProfessorQuery = em.createNamedQuery(Professor.ID_PROFESSOR_QUERY, Professor.class);
